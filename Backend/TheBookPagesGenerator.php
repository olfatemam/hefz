 ...
 */
    ...
    require_once 'TheBookAttributes.php';
    require_once 'Models/Chapter.php';
    require_once 'Models/Html/SVGElement.php';

class TheBookPagesGenerator
{
    ...
    public function __construct()
    {
        ...
        $this->data_folder=$config['app_folder'].'/data/';
    ...
    public function add_border($newxml, $border_tag, $x, $y, $f_sura_border)
    {
        ...
        $box1 = new SVGElement($pathSegments[0], 0);
        if( $pathSegments[0][6]== 'M' || $pathSegments[0][6]== 'm' )
            $box2 = new SVGElement($pathSegments[0], 6);
        else
            $box2=$box1;
    ...
    public function setup_chapter_paging($TheBookAttributes, $pchapter, $begin_at_page)
    {
        ...
        {
            $master_page = $TheBookAttributes->get_inital_page_by_number('data/xml/', $page);
            ...
            if($remainder==0)
            {
                ...
                $obj = new PageAttributes($page,$begin, $pchapter->get_chapter_verses());
            ...
            if($remainder>0)
            {
                $end=$begin+$page_size-1;
                $master_page->set_available_number_of_verses(0);
                $obj = new PageAttributes($page,$begin, $end);
                $pchapter->add_page($obj);
